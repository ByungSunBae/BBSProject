...
flags.DEFINE_boolean('only_cpu', False, """If true, Only use CPU.""")
...
with tf.device("/cpu:0"):
    ...
    with slim.arg_scope([slim.fully_connected],
        ...
        net2 = DnnSkipModule(inputs=net1, num_outputs=400, n=2)
        ...
        net6 = slim.fully_connected(inputs=net2, num_outputs=200, scope = "net6")
